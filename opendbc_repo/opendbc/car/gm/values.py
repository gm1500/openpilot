...
class CarControllerParams:
  ...
  def __init__(self, CP):
    ...
    self.DRAG_CONSTANT = 0.3  # reasonable nominal value for GM platforms
...
class CAR(Platforms):
  ...
  CHEVROLET_SILVERADO = GMPlatformConfig(
    ...
    GMCarSpecs(mass=2450, wheelbase=3.75, steerRatio=17.6, centerToFrontRatio=0.75,
               tireStiffnessFactor=1.0, wheelRadius=0.425),
  )
