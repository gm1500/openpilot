...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"AnchorLanePolicyActive", {CLEAR_ON_MANAGER_START | CLEAR_ON_ONROAD_TRANSITION, BOOL}},
    {"AnchorLanePolicyEnabled", {CLEAR_ON_MANAGER_START | CLEAR_ON_ONROAD_TRANSITION, BOOL, "1"}},
    {"AnchorLanePolicyHolding", {CLEAR_ON_MANAGER_START | CLEAR_ON_ONROAD_TRANSITION, BOOL}},
