...
from openpilot.selfdrive.ui.onroad.lane_policy_button import LanePolicyButton
...
class HudRenderer(Widget):
  def __init__(self):
    ...
    self._lane_policy_button: LanePolicyButton = self._child(LanePolicyButton())
  ...
  def user_interacting(self) -> bool:
    return self._exp_button.is_pressed or self._lane_policy_button.is_pressed
